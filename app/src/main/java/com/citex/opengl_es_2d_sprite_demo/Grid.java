...
class Grid {
    ...
    /**
     * Construct the Grid
     * @param vertsAcross The number of verts across
     * @param vertsDown The number of verts down 
     * @param useFixedPoint Use fixed point arithmetic
     */
    ...
    /**
     * Sets the OpenGL state for drawing textures
     */
    ...
    /**
     * Returns the use of a hardware buffer
     * @return Is Hardwared buffer enabled
     */
